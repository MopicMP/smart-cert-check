...
> Smart check ssl certificate expiration dates

[![PyPI version](https://badge.fury.io/py/smart-cert-check.svg)](https://pypi.org/project/smart-cert-check/)
...
from smart_cert_check import batch
